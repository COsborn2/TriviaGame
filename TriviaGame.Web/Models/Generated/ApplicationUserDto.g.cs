...
{
    public partial class ApplicationUserDtoGen : GeneratedDto<TriviaGame.Data.Models.ApplicationUser>
    {
        ...
        /// </summary>
        public override void MapFrom(TriviaGame.Data.Models.ApplicationUser obj, IMappingContext context, IncludeTree tree = null)
        {
            if (obj == null) return;
        ...
        /// </summary>
        public override void MapTo(TriviaGame.Data.Models.ApplicationUser entity, IMappingContext context)
        {
            var includes = context.Includes;
