...
namespace TriviaGame.Web.Api
{
    ...
    public partial class ApplicationUserController
        : BaseApiController<TriviaGame.Data.Models.ApplicationUser, ApplicationUserDtoGen, TriviaGame.Data.AppDbContext>
    {
        public ApplicationUserController(TriviaGame.Data.AppDbContext db) : base(db)
        {
            GeneratedForClassViewModel = ReflectionRepository.Global.GetClassViewModel<TriviaGame.Data.Models.ApplicationUser>();
        }
        ...
        public virtual Task<ItemResult<ApplicationUserDtoGen>> Get(
            ...
            IDataSource<TriviaGame.Data.Models.ApplicationUser> dataSource)
        ...
        public virtual Task<ItemResult<ApplicationUserDtoGen>> Save(
            ...
            IDataSource<TriviaGame.Data.Models.ApplicationUser> dataSource,
            IBehaviors<TriviaGame.Data.Models.ApplicationUser> behaviors)
