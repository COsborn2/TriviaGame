...
export class TriviaBoard {
  ...
  public static convert(data?: Partial<TriviaBoard>): TriviaBoard {
  ...
  public static map(data?: Partial<TriviaBoard>): TriviaBoard {
...
export class TriviaAnswer {
  ...
  public static convert(data?: Partial<TriviaAnswer>): TriviaAnswer {
  ...
  public static map(data?: Partial<TriviaAnswer>): TriviaAnswer {
